...
// Create ChildAccount and add it to the UserAccountManager
        ChildAccount childAccount = userAccountManager.addChildAccount(childUsername, childPassword, userAccountManager.getParentId());
